...
Also, you might have noticed that there is something like that `(watermark:1.3), (text:1.3), (signature:1.3)` in the last prompt. These are called **prompt weights**. You can use these weights in both propmt and negative prompt. You can use this to emphasize some words in propmt or vice versa. You can take a look https://dev.dezgo.com/guides/prompt-weighting/ and https://getimg.ai/guides/guide-to-stable-diffusion-prompt-weights websites.
